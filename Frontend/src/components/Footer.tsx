...
export function Footer() {
  ...
  const [type, setType] = useState<"report" | "suggestion" | "feedback" | "inappropriate">(
    "feedback",
  );
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
            ...
            <div className="md:col-span-1 space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                A hyperlocal circular community platform. Re-home pre-loved items with neighbours
                freely — zero cost, zero waste.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm font-medium">
                <li>
                  <Link
                    to="/reviews"
                    className="inline-flex items-center gap-1.5 text-muted-foreground hover:text-emerald-700 transition-colors"
                  >
                ...
                <li>
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 text-muted-foreground hover:text-amber-700 transition-colors text-left"
                  >
            ...
            <div className="p-5 rounded-2xl bg-muted/40 border border-border/80 space-y-3">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Have questions, feedback, or need to report an issue directly to our admin team?
              </p>

              <button
                type="button"
                onClick={() => handleOpenFeedback("feedback")}
                className="inline-flex items-center justify-center gap-2 w-full bg-emerald-700 hover:bg-emerald-800 text-white px-4 py-2.5 rounded-xl text-xs font-semibold shadow-sm transition-colors"
              >
                <span>Submit Feedback or Report</span>
              </button>
            </div>
          </div>
